...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        private String responseTiempoArriboColectivo = "", latParadaActualColectivo = "", lngParadaActualColectivo="", fechaParadaActual="",  latParadaActualPasajero="", lngParadaActualPasajero="", paradaActualColeDire="", codigoError="";
...
//            txtCodigo = (TextView) itemView.findViewById(R.id.txtCodigo);
        ...
        public void setmItem(String item){
            ...
            System.out.println("los datos del item que entro al recycler view " + item);
            mItem = item;
...
//                                Set<String> set = intent.putStringSet("key", null);
//                                paradasPorRecorrerList
                                // ver como pasar la lista
            ...
            if(ma2.activeNetwork != null){
                ...
                final Runnable r = new Runnable(){
                    public void run(){
                        ...
                        // obtiene el tiempo de arribo desde getSharedPreference
                        preferencesArriboCole = ma2.getSharedPreferences("DataArriboCole", Context.MODE_PRIVATE);
                        Map<String, ?> allEntries = preferencesArriboCole.getAll();
                        for(Map.Entry<String,?> entry : allEntries.entrySet()){
                            if (entry.getKey().equals("TiempoArribo"))
                                //System.out.println("La key dentro del recycler view: " + entry.getValue().toString());
